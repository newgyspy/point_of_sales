      ...
      <a href="logout.php"><img src="images/logout.png" width="94" height="22" border="0"></a></td>
		...
		<table border="1" bgcolor="lavender">
			<tr>
				...
				<td>NUMBER OF DAYS TO EXPIRE</td>
...
<?php
  ...
  $connection=mysql_connect("localhost","root","");
			   ...
			   $currentdate=$_POST["near"];
               

			  $result2 ="SELECT * FROM stock_entries where p <7 order by date desc";
...
echo 'alert("Please the following lists all the Drugs which  are about to expire in 1  week (7 days) so ckeck your stock")';
echo '</script>';
