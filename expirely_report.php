...
{
if(isset($_POST['from_expense_date2']) && isset($_POST['to_expense_date2']) )
{
	include_once "db.php"; 
	error_reporting (E_ALL ^ E_NOTICE);
			$selected_date=$_POST['from_expense_date2'];
		  	$selected_date=strtotime( $selected_date );
			$mysqldate = date( 'Y-m-d H:i:s', $selected_date );
$fromdate=$mysqldate;
			$selected_date=$_POST['to_expense_date2'];
		  	$selected_date=strtotime( $selected_date );
			$mysqldate = date( 'Y-m-d H:i:s', $selected_date );
      ...
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="393">&nbsp;<?php echo $_POST['from_expense_date2']; ?></td>
                <td width="41"><strong>To</strong></td>
                <td width="116">&nbsp;<?php echo $_POST['to_expense_date2']; ?></td>
              </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="100%"  border="2" cellspacing="0" cellpadding="0">
              <tr>
                <td><strong>Expirely Date</strong></td>
			  ...
			  if(isset($_POST["submit2"])){
				...
				$a=$_POST['from_expense_date2'];
		  	$a=strtotime( $a );
			$mysqldate = date( 'Y-m-d H:i:s', $a);
			
			
			
			$a1=$_POST['to_expense_date2'];
		  	$a1=strtotime( $a1 );
			$mysqldate1 = date( 'Y-m-d H:i:s', $a1);
			
			  $result ="SELECT * FROM  stock_entries where due BETWEEN '$mysqldate' AND '$mysqldate1' ";
...
<?php 
echo"<br/>";
echo"<center>Below are the  details of stock expiries with in the specified period of time.</center>";
echo"<br/>";
echo"<br/>";
 ?>
