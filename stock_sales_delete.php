...
else
{
  ...
  while ($line = $db->fetchNextObject($result)) {
				...
				$id=$db->queryUniqueValue("SELECT id FROM stock_entries WHERE  stock_name='$line->stock_name'");
				...
				$db->execute("DELETE FROM stock_entries WHERE  stock_name='$line->stock_name'");
