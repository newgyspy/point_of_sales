...
<?php
  ...
  $connection=mysql_connect("localhost","root","");
			   ...
			   $currentdate=$_POST["near3"];
               

			  $result2 ="SELECT * FROM stock_sales where  balance>0 and p>0 order by date desc";
...
echo 'alert("Please the following lists all the customers which  are about to pay  so ckeck your outstanding list")';
echo '</script>';
