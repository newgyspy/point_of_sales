...
{
if(isset($_POST['from_expense_date']) && isset($_POST['to_expense_date']) )
{
	include_once "db.php"; 
	error_reporting (E_ALL ^ E_NOTICE);
			$selected_date=$_POST['from_expense_date'];
		  	$selected_date=strtotime( $selected_date );
			$mysqldate = date( 'Y-m-d H:i:s', $selected_date );
$fromdate=$mysqldate;
			$selected_date=$_POST['to_expense_date'];
		  	$selected_date=strtotime( $selected_date );
			$mysqldate = date( 'Y-m-d H:i:s', $selected_date );
    ...
    <td align="center">
      <table width="595" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="393">&nbsp;<?php echo $_POST['from_expense_date']; ?></td>
                <td width="41"><strong>To</strong></td>
                <td width="116">&nbsp;<?php echo $_POST['to_expense_date']; ?></td>
              </tr>
          </table></td>
        </tr>
        <tr>
		...
		<td><strong>Amount</strong></td>
			  ...
			  $a=$_POST['from_expense_date'];
			  $a1=$_POST['to_expense_date'];
			  $result ="SELECT * FROM expences where date BETWEEN '$a' AND '$a1' ";
			  $result1 ="SELECT sum(amount) FROM expences where date BETWEEN '$a' AND '$a1' ";
...
<?php echo "The Total expense is"." ". $line1["sum(amount)"]." "."sh from ".$a." "."to"." ".$a1;
echo"<br/>";
echo"<br/>";
echo"<center>Below are the sub expenses with in the specified period of time.</center>";
echo"<br/>";
echo"<br/>";
 ?>
