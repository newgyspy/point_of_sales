        ...
        <div class="row-fluid">
            <div class="span10">
                <ul class="breadcrumb">
                    ...
                    <li><a href="login_student.php"><i class="icon-group icon-large"></i>&nbsp;Administrator</a><span class="divider">/</span></li>
                    <li  class="active"><i class="icon-group icon-large"></i>&nbsp;Patient</li>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Login Patient!</strong>&nbsp;Please Enter the Details Below.
                </div>
