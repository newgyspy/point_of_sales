...
$selectclans="select * from group_schools ";
...
<td><a href="sendsmsschool.php?tel=<?php echo $row['contact'].','. $row['contact2'].','.$row['contact3']; ?>">Send To This Contact</a></td>

<td><a href="sendsmsToAllschools.php?tel=<?php echo $row['contact'].','. $row['contact2'].','.$row['contact3']; ?>">Send To All</a></td>

<td><a href="selectClassToSendToschool.php?zone=<?php echo $row['zone']; ?>">Send To One Zone</a></td>
