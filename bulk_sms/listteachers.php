...
$selectclans="select * from group_teachers ";
...
<td><a href="sendsmsteacher.php?tel=<?php echo $row['contact'].','. $row['contact2'].','.$row['contact3']; ?>">Send To This Contact</a></td>

<td><a href="sendsmsToAllteachers.php?tel=<?php echo $row['contact'].','. $row['contact2'].','.$row['contact3']; ?>">Send To All</a></td>

<td><a href="selectClassToSendToteacher.php?level=<?php echo $row['level']; ?>&subject=<?php echo $row['subject']; ?>">Send To One Subject And Level</a></td>
