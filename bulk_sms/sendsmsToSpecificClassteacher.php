...
$selectallcontacts="select * from group_teachers where level='$getlevelfromurl' and subject='$getsubjectfromurl' ";
...
<a href="listteachers.php">Click here to move back</a>
                            </div>
