        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <div class="alert alert-info">
                    ...
                    <strong><i class="icon-user icon-large"></i>&nbsp;TEACHERS PANEL</strong>
                </div>
                <div class="hero-unit-2">
                    <form class="form-horizontal" method="POST" action="sendsmsToSpecificClass.php?level=<?php $_POST['level']; ?>&subject=<?php $_POST['subject']; ?>">
                         
                        <div class="control-group">
                            <label class="control-label" for="inputEmail">SEND TO ALL TEACHERS OF</label>
                            <div class="controls">

                                <input type="text" name="level"  class="span5" required value="<?php echo $_GET['level']; ?>" readonly="" />
                                <input type="text" name="subject"  class="span5" required value="<?php echo $_GET['subject']; ?>" readonly="" />
                                </div>
                    ...
                    <center>
                    <i class="icon-plus-sign icon-large"></i>&nbsp;<a href="sendsmsToSpecificClassteacher.php?level=<?php echo $_GET['level'] ; ?>&subject=<?php echo $_GET['subject'] ; ?>">CONTINUE</a>
                    </center>
                </div>
