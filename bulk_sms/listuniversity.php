                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;UNIVERSITY CONTACTS</strong>
                        </div>
         <center>
...
$selectclans="select * from group_university";
...
<td><a href="sendsmsToAlluniversity.php?tel=<?php echo $row['contact'].','. $row['contact2'].','.$row['contact3']; ?>">Send To All</a></td>
