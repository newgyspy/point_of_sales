                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                               ...
                               <center> <div class="span6"> ORION BULK SMS SERVICE</div></center>
                            <div class="span6">
                                <div class="pull-right">
                                    <!--- login button -->							
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="#student" role="button"  data-toggle="modal"><i class="icon-user icon-large"></i>&nbsp;Patient/Parent</a></li>
                                            <li><a href="#teacher" role="button"  data-toggle="modal"><i class="icon-user-md icon-large"></i>&nbsp;Administrator</a></li>

                                        </ul>
                                    </div>

                                    <!-- end login -->
                                    <?php include('tourist_modal.php'); ?>
