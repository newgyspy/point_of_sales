...
mysql_connect("localhost", "root" , "" )or die("cannot connect to database server");  
	mysql_select_db("stock")or die("cannot select the database");
	

 if(isset($_POST['insert']))
	{	
		//check if every fields are entered
		if(!$_POST['pay'] | !$_POST['bmonth']| !$_POST['bday']| !$_POST['byear'])
		{
...
<?php
		...
		{
			if($_GET['err']==1)
				echo '<div class="error_pop"><div class="error"><center>Please input basic pay and date<a href="entry.php"><h6>Close</h6></a></center></div></div>
		';
...
echo '<input type="text" name="empno" class="id_empno" value='.$row['empno'].' readonly>';
  ...
  echo '</td>';
   ...
   ?>
         ...
         <tr>
    <td>Basic Rate</td>
    <td><input type="text" name="pay" value="<?php echo $pay; ?>" tabindex="12" title="Enter Number" onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';}  /></td>
  </tr> <tr>
    <td>Days worked</td>
    <td><input type="text" name="dayswork" value="<?php echo $dayswork; ?>" tabindex="13" title="Enter Number"onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';} /></td></tr>
  
  <tr>
    <td>Overtime Rate/Hour</td>
    <td><input type="text" name="otrate" value="<?php echo $otrate; ?>" tabindex="14" title="Enter Number"onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';} /></td>
  </tr>
  <tr>
    <td>OT Hours</td>
    <td><input type="text" name="othrs" value="<?php echo $othrs; ?>" tabindex="15" title="Enter Number"onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';} /></td>
  </tr>
  <tr>
    <td>Allowances</td>
    <td><input type="text" name="allow" value="<?php echo $allow; ?>" tabindex="16" title="Enter Number"onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';} /></td>
  </tr>
  <tr>
    <td>Advances</td>
    <td><input type="text" name="advances" value="<?php echo $advances; ?>" tabindex="17" title="Enter Number"onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';} /></td>
  </tr>
  <tr>
    <td>Insurance</td>
    <td><input type="text" name="insurance" value="<?php echo $insurance; ?>" tabindex="18" title="Enter Number"onFocus="if (this.value == '0') {this.value = '0';}" onBlur="if (this.value == '0')" {this.value = '0';} /></td>
  </tr>
  <td>Date Period</td>
	<center>
	...
	<input type="text" name="bday" value="<?php echo $bday; ?>" size="2" maxlength="2" tabindex="8" id="bday"  onFocus="if (this.value == 'DD') {this.value = '0';}" onBlur="if (this.value == 'DD')" {this.value = 'DD';} />
    <input type="text" name="byear" value="<?php echo $byear; ?>" size="4" maxlength="4" tabindex="9" id="byear" onFocus="if (this.value == 'YYYY') {this.value = '0';}" onBlur="if (this.value == 'YYYY')" {this.value = 'YYYY';} /></td>
	</center>
  </tr>
  <tr>
