...
<center><h1>GUARDIAN PHARMACY PAYROLL SLIP</h1></center>
<a href="../admin.php">Exit from here</a>
<br/>
<br/>
...
while ($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
  ...
  $totdeduct = $row['advances'] + $row['insurance']; 
...
if (isset($_GET['empno'])) {
  ...
  $query1 = "SELECT * FROM employee WHERE empno= $empno";
  include 'include/dbconnection.php';
  $result = mysql_query($query,$link) or die (mysql_error());
...
<tr>
    <td class="box" width="">Date</td>
    <td >:<?php echo $row1["time"]; ?></td></tr>
     <tr>
  <tr>
...
<table border="0"  width="417" cellspacing="0">
  ...
  <tr><td class="align2"><b><div class="align3"> <?  echo number_format("$gross",2);?></div></b>
